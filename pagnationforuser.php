...
<?php
       ...
       elseif(isset($_GET['send'])){
        ...
        $sql = "SELECT * FROM product WHERE category IN (SELECT name FROM category WHERE statu = 'yes') and status = 'yes' and new_price >= $prix_start and new_price <= $prix_end";

      }
      if(isset($_GET['send']) && isset($_GET['sendcategory'])){
        $prix_start =  $_GET['prix_start'];
        $prix_end = $_GET['prix_end'];
        $sql = "SELECT * FROM product WHERE category IN (SELECT name FROM category WHERE statu = 'yes') and status = 'yes' and new_price >= $prix_start and new_price <= $prix_end and category like '$select'";
